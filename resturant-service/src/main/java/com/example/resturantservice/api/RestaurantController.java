...
public class RestaurantController {
    ...
    @PostMapping("/orders")
    public ResponseEntity<OrderRequestDTO> sendOrder(@RequestBody OrderRequestDTO orderRequestDTO) {
        OrderRequestDTO orderRequestDTO1 = resturantOrderService.send(orderRequestDTO);
        return new ResponseEntity<>(orderRequestDTO1, HttpStatus.OK);
    }
}
